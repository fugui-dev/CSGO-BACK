package com.ruoyi.thirdparty.msPay.controller;
...
import com.ruoyi.thirdparty.msPay.service.MsPayService;
...
public class MsPayController extends BaseController {
    ...
    public R<UnifyPayPreOrderVO> preOrder(HttpServletRequest request, @RequestBody @Validated CreateOrderParam param) {
        ...
        return msPayService.preOrder(param, user, request);
    }
    ...
    public String notify(HttpServletRequest request) {
        ...
        //处理回调
        try {
            return msPayService.callback(request);
