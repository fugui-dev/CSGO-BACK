package com.ruoyi.thirdparty.decsgopay.yspay.controller;
...
import com.ruoyi.thirdparty.decsgopay.yspay.service.YSPayService;
...
public class YSPayController extends BaseController {
    ...
    public R<UnifyPayPreOrderVO> preOrder(HttpServletRequest request, @RequestBody @Validated CreateOrderParam param) {
        ...
        return ysPayService.preOrder(param, user, request);
    }
    ...
    public String notify(HttpServletRequest request) {
        ...
        //处理回调
        try {
            return ysPayService.callback(request);
