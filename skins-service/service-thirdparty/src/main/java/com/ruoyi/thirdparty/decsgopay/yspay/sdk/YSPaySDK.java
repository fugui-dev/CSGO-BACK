...
import com.ruoyi.thirdparty.decsgopay.csgopay.sdk.MD5Util;
...
@Slf4j
public class YSPaySDK {

    private YSPayConfig payConfig;

    public YSPaySDK(YSPayConfig payConfig){
    ...
    public JSONObject preOrder(String payType, String orderNo, String goodsName, String money) {
        try {
            ...
            log.info("下单请求config【{}】：", payConfig);
            log.info("下单请求url【{}】请求体【{}】：", requestUrl, parameters);
